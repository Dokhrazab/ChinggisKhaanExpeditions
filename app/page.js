    ...
    <div className="min-h-screen bg-[#F8F5F0] text-[#1A1A1A] font-sans selection:bg-[#C5A059] selection:text-white">
      ...
      <nav className="fixed top-0 w-full z-50 glass border-b border-black/5 px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex gap-8 items-center">
          ...
          <a href="mailto:chinggiskhanexpeditions@gmail.com" className="bg-[#1A1A1A] text-white px-6 py-2.5 rounded-full text-sm font-semibold hover:bg-[#C5A059] transition-all shadow-lg hover:shadow-xl active:scale-95">
            Inquire Now
          </a>
        </div>
      </nav>
