      ...
      <div className="pt-32 pb-24 px-6">
        <div className="max-w-6xl mx-auto">
          <header className="mb-24 text-center">
            <span className="text-[#C5A059] font-bold tracking-[0.4em] uppercase text-[10px] mb-4 block">Field Intel</span>
            <h1 className="text-6xl md:text-8xl font-serif font-extrabold text-[#1A1A1A] tracking-tighter uppercase">Travel Guide</h1>
          </header>
